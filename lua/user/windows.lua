...
vim.g.signer_path = vim.env.HOME .. "/AppData/Local/Programs/Microsoft VS Code/2242ebbb54/resources/app/node_modules.asar.unpacked/vsda/build/Release/vsda.node"
vim.g.debugger_path = vim.env.HOME .. "/.vscode/extensions/ms-dotnettools.csharp-2.160.4-win32-x64/.debugger/x86_64/vsdbg-ui.exe"
vim.g.cppdbg_path = vim.env.HOME .. "/.vscode/extensions/ms-vscode.cpptools-1.35.2-win32-x64/debugAdapters/bin/OpenDebugAD7.exe"
