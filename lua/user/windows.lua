...
vim.g.signer_path = vim.env.HOME .. "/AppData/Local/Programs/Microsoft VS Code/110a328ea5/resources/app/node_modules.asar.unpacked/vsda/build/Release/vsda.node"
