...
vim.g.signer_path = vim.env.HOME .. "/AppData/Local/Programs/Microsoft VS Code/df53daabb1/resources/app/node_modules.asar.unpacked/vsda/build/Release/vsda.node"
